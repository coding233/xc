...
public class TestSearch {
    ...
    public void testMatchQuery() throws IOException, ParseException {
        ...
        //搜索方式
        //MatchQuery
        searchSourceBuilder.query(QueryBuilders.matchQuery("description","java开发")
    ...
    public void testMultiMatchQuery() throws IOException, ParseException {
        ...
        //搜索方式
        //MultiMatchQuery
        searchSourceBuilder.query(QueryBuilders.multiMatchQuery("java开发","name","description")
    ...
    public void testFilter() throws IOException, ParseException {
        ...
        boolQueryBuilder.filter(QueryBuilders.rangeQuery("price").gte(20).lte(40));
